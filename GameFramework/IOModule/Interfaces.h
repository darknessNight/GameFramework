...
#pragma region Events
			...
			Core::Events::Event<Events::MouseButtonArgs> MouseButtonPress;
			...
			Core::Events::Event<Events::JoystickButtonArgs> JoystickButtonPress;
			...
			Core::Events::Event<Events::MouseButtonArgs> MouseButtonPressAsync;
			...
			Core::Events::Event<Events::JoystickButtonArgs> JoystickButtonPressAsync;
